    ...
    <ScrollView style={{ backgroundColor: theme.colors.surface0 }}>
      <Container style={{ maxWidth: 1120, paddingVertical: spacing[10] }}>
        ...
        <Section title="Lockup Spacing" kicker="Signature rules">
          ...
          <Text size="sm" color="muted" style={{ maxWidth: 760 }}>
            Set the mark at 1.18x the wordmark size, so its height tracks the
            wordmark's ascenders and the two read as one line. The gap is one
            quarter of the mark height. Keep at least half a mark of clear space
            around the whole lockup. Minimum sizes: 16px for the mark, 20px
            wordmark size for the full lockup.
          </Text>
        </Section>
