...
export function Wordmark({
  ...
  dotColor?: string;
  /** Wordmark weight — "semibold" is the signature default; "medium" is
   * available for lighter chrome. */
...
export function LogoLockup({
  ...
  // Mark set to 1.18x the wordmark size so its height tracks the wordmark's
  // ascenders — the two read as a single line rather than an oversized icon
  // beside smaller text. Gap stays a quarter of the mark height.
